...
public class BPlusTree {
   ...
   */
    ...
    public boolean hasNext() {
      ...
      this.currLeaf = (LeafNode) BPlusNode.getBPlusNode(BPlusTree.this, this.currLeaf.getNextLeaf());
      if (this.isScan) {
    ...
    public RecordID next() {
      if (this.currLeaf == null || !this.currLeafIter.hasNext()) {

...
public class IndexScanOperator extends QueryOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    try {
      ...
      float reductionFactor = stats.getReductionFactor(this.columnIndex, this.predicate, this.value);
      int indexPages = this.transaction.getNumIndexPages(this.tableName, this.columnName);
      long numRecords = this.transaction.getNumRecords(this.tableName);
      return (int) Math.ceil((indexPages + numRecords) * reductionFactor);
